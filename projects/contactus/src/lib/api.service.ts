...
export class ApiService {
  ...
  public accesstoken: any = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmb28iOiJiYXIiLCJleHAiOjE1NjUwOTI3NzksImlhdCI6MTU2NTAwNjM3OX0.TjUTpp7N0TeyG-rgruiRe4b0zOSqT2GtxgBH8Z4dgjc';
  fileservername: any = [];
  serverUrl: any;
  addendpointUrl: any;

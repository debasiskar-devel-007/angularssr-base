...
export class ApiService {
  ...
  public accesstoken:any='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmb28iOiJiYXIiLCJleHAiOjE1NjYzODQ4MzIsImlhdCI6MTU2NjI5ODQzMn0.HpV6nbWULdOvSo6KZvxtCeXjpPBfsDWF4-WlSxppTIk';
  fileservername: any = [];
  serverUrl: any;
  addendpointUrl: any;
